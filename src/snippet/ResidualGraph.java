...
public class ResidualGraph {
		...
		public Iterator<ResidualVertex> vertices(){
			return vertexList.iterator();
		}
		
		public Iterator<ResidualEdge> edges(){
			return edgeList.iterator();
		}
		
		public Iterator<ResidualEdge> nextEdgeList(ResidualVertex v){
		...
		public ResidualEdge getEdge(ResidualVertex start, ResidualVertex end){
			Iterator<ResidualEdge> iterator = nextEdgeList(start);
			ResidualEdge result;
