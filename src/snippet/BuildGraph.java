...
public class BuildGraph {
	...
	public static void main(String[] args) {
		BuildGraph("200v-50e-1min-200max.txt", ".", 200, 50, 200, 1);
	}

	private static void BuildGraph(String fileName, String directory, int vertices, int dense, int maxCapacity,
			int minCapacity) {
